 ...
 * @author bhavyag
 */
public class ClientIPValidationFactoryCustomUserStore implements AuthenticatorFactory {

	private static final String PROVIDER_ID = "ip-validator-custom-user-store";
	@Override
	public String getId() {
		return PROVIDER_ID;
	}
	...
	public Authenticator create(KeycloakSession session) {
		return new ClientIPValidatorCustomUserStore();
	}
