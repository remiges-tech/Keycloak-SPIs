 ...
 * @author bhavyag
 */
public class SmsAuthenticatorFactoryCustomUserStore implements AuthenticatorFactory{

	private static final String PROVIDER_ID = "sms-authenticator-custom-user-store";
	...
	public Authenticator create(KeycloakSession session) {
		return new SmsAuthenticatorCustomUserStore();
	}
